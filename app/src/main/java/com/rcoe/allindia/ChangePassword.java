                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                user.updatePassword(newP).addOnCompleteListener(new OnCompleteListener<Void>()
                                {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task)
                                    {
                                        ...
                                        {
                                            progressDialog.dismiss();
                                            Toast.makeText(ChangePassword.this,"Password Not Updated !",Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                            }
    ...
    public boolean validate() {
        ...
        if(Pattern.compile(PASSWORD_PATTERN).matcher(oldP).matches() != true) {
            if (oldP.isEmpty()) {
                ...
                passwordAlertdialogBox(ChangePassword.this);
            }
            valid = false;
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case R.id.new_complaint_registration:
                startActivity(new Intent(ChangePassword.this, Welcome.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;
            ...
            case R.id.complaint_status :
                startActivity(new Intent(ChangePassword.this,ComplaintStatus.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;

            case R.id.search_complaint :
                startActivity(new Intent(ChangePassword.this,ComplaintSearch.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;

            case R.id.logout:
                super.alert(R.layout.logout_alert,ChangePassword.this,auth);
                break;
            ...
            case R.id.chats :
                startActivity(new Intent(ChangePassword.this,ChatActivity.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;

            case R.id.find_friends :
                startActivity(new Intent(ChangePassword.this, FindFriends.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;

            case R.id.received_requests :
                startActivity(new Intent(ChangePassword.this, Requests.class));
                finish();
                overridePendingTransition(R.anim.slide_in_right,R.anim.slide_out_left);
                break;
